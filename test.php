...
if($_GET['where'] == "1"){
			...
			$result=mysqli_query($connect,"CALL addFavourite(".$json.")")or die("Query fail:".mysqli_error($connect));
			...
			$result=mysqli_query($connect,"CALL addVisit(".$json.")")or die("Query fail:".mysqli_error($connect));
		...
		$result=mysqli_query($connect,"CALL getUserDetail(".$obj->{'uemail'}.",".$obj->{'upassword'}.")")or die("Query fail:".mysqli_error($connect));
		   ...
		   $result=mysqli_query($connect,$queryval)or die("Query fail:".mysqli_error($connect));
		    ...
		    $dir = "/home/campusprodelta/public_html/androidphpcsc/assets/hostel/".$_GET['hostelname'];
